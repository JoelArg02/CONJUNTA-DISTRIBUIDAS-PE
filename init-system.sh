...
build_service() {
    ...
    echo "✅ Imagen $service:latest construida exitosamente"
}

# Limpiar recursos anteriores si existen
echo "🧹 Limpiando recursos anteriores..."
./cleanup-k8s.sh 2>/dev/null || true
sleep 5
...
# Abrir el dashboard principal (Minikube Dashboard)
...
echo "  🎛️ Abrir dashboard:       minikube dashboard"
echo ""
